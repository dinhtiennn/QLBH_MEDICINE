...
<body>
	...
	<div class="container">
		 <table class="table">
			...
			ArrayList<DonHangBEAN> dsdonhang = (ArrayList<DonHangBEAN>)request.getAttribute("dsalldhxacnhan");
					...
					for(int i = 0; i< soLuongHoaDon; i++){
						...
						%>
				  		<tr>
			      			...
			      			<td><a href="donhang?action=showctdh&iddonhang=<%=dsdonhang.get(i).getIdDonHang()%>"><button type="button" class="btn btn-success btn-sm">Chi tiết đơn hàng</button></a></td>
					     </tr>   
					<%}%>
	  		</tbody>
			<%}else if(dsctdh!=null){
